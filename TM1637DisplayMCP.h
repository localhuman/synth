...
#ifndef __TM1637DISPLAYMCP__
#define __TM1637DISPLAYMCP__
...
class TM1637DisplayMCP {

public:
  //! Initialize a TM1637DisplayMCP object, setting the clock and
  //! data pins.
  //!
  //! @param pinClk - The number of the digital pin connected to the clock pin of the module
  //! @param pinDIO - The number of the digital pin connected to the DIO pin of the module
  //! @param mcp - The MCP device the display in connected to
  //! @param bitDelay - The delay, in microseconds, between bit transition on the serial  
  //!                   bus connected to the display

  TM1637DisplayMCP(uint8_t pinClk, uint8_t pinDIO, Adafruit_MCP23X17 *mcp, unsigned int bitDelay = DEFAULT_BIT_DELAY);

  // Call to initialize the device
  void init();
